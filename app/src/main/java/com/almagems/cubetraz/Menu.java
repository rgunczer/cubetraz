...
//}
    ...
    public void drawTextsTitles(Color color) {
        ...
        if ( Math.abs(m_navigator.m_cube_rotation_secondary.degree) < EPSILON) {
            drawTextsDefaultOrientation(m_lst_titles[Face_X_Plus], m_lst_titles[Face_X_Minus], 
                                        m_lst_titles[Face_Y_Plus], m_lst_titles[Face_Y_Minus], 
                                        m_lst_titles[Face_Z_Plus],  m_lst_titles[Face_Z_Minus], 
                                        color);
        } else {
            switch (m_current_cube_face) {
                case Face_Easy01:
                ...
                case Face_Easy03:
                case Face_Easy04:
                    drawEasyTitles(m_lst_titles[Face_X_Plus], m_lst_titles[Face_X_Minus], 
                                   m_lst_titles[Face_Y_Plus], m_lst_titles[Face_Y_Minus], 
                                   m_lst_titles[Face_Z_Plus],  m_lst_titles[Face_Z_Minus], 
                                   color);
                    break;
                ...
                case Face_Normal03:
                case Face_Normal04:
                    drawNormalTitles(m_lst_titles[Face_X_Plus], m_lst_titles[Face_X_Minus], 
                                     m_lst_titles[Face_Y_Plus], m_lst_titles[Face_Y_Minus], 
                                     m_lst_titles[Face_Z_Plus],  m_lst_titles[Face_Z_Minus], 
                                     color);
                    break;
                ...
                case Face_Hard03:
                case Face_Hard04:
                    drawHardTitles(m_lst_titles[Face_X_Plus], m_lst_titles[Face_X_Minus], 
                                   m_lst_titles[Face_Y_Plus], m_lst_titles[Face_Y_Minus], 
                                   m_lst_titles[Face_Z_Plus],  m_lst_titles[Face_Z_Minus], 
                                   color);
                    break;
            ...
            switch (m_current_cube_face) {
                case Face_Tutorial:
                    ...
                    if (m_pMenuCubePlay.m_cube_pos.y == 7 && m_can_alter_text) {
                        ...
                        MenuFaceBuilder.addTransform(MirrorVert);
                        releaseCubeTextsOnFace(Face_X_Minus);
                        MenuFaceBuilder.buildTexts(Face_Tutorial, Face_X_Minus, true);
                    }
                    ...
                    if (m_pMenuCubePlay.m_cube_pos.y == 1 && m_can_alter_text) {
                        ...
                        MenuFaceBuilder.addTransform(MirrorVert);
                        releaseCubeTextsOnFace(Face_X_Minus);
                        MenuFaceBuilder.buildTexts(Face_Tutorial, Face_X_Minus);
                    }
                    break;
...
//                    }
    ...
    public void updateCubes() {
        ...
        for (int i = 0; i < size; ++i) {
            ...
            face_type = Face_X_Plus;
            if (null != cube.ar_fonts[face_type]) {
                m_lst_texts[face_type].add(cube.ar_fonts[face_type]);
            }

            if (null != cube.ar_symbols[face_type]) {
                m_lst_symbols[face_type].add(cube.ar_symbols[face_type]);
            }
        ...
        for (int i = 0; i < size; ++i) {
            ...
            face_type = Face_X_Plus;
            if (null != cube.ar_fonts[face_type]) {
                m_lst_titles[face_type].add(cube.ar_fonts[face_type]);
            }
...
//    printf("\nFace_Y_Symbol Size: %lu", m_lst_symbols[Face_Y_Plus].size());
    ...
    public void updateHilite() {
        ...
        if (m_hilite_timeout < 0.0f) {
            ...
            if (!m_pMenuCubePlay.lst_cubes_to_hilite.isEmpty()) {
                Cube p = m_pMenuCubePlay.lst_cubes_to_hilite.front();
            ...
            if (!m_pMenuCubeOptions.lst_cubes_to_hilite.isEmpty()) {
                Cube p = m_pMenuCubeOptions.lst_cubes_to_hilite.front();
            ...
            if (!m_pMenuCubeStore.lst_cubes_to_hilite.isEmpty()) {
                Cube p = m_pMenuCubeStore.lst_cubes_to_hilite.front();
            ...
            if (!m_pStoreCubeNoAds.lst_cubes_to_hilite.isEmpty()) {
                Cube p = m_pStoreCubeNoAds.lst_cubes_to_hilite.front();
            ...
            if (!m_pStoreCubeRestore.lst_cubes_to_hilite.isEmpty()) {
                Cube p = m_pStoreCubeRestore.lst_cubes_to_hilite.front();
    ...
    public void Update() {
        if (m_showing_help) {
            ...
            if (m_show_help_timeout < 0.0f) {
                ...
                MenuFaceBuilder.resetTransforms();
                MenuFaceBuilder.buildTexts(Face_Menu, Face_Z_Plus, false);
            }
        }
    ...
    public void eventPlayLevel(DifficultyEnum difficulty, int level_number) {
        if (false == Game.getCanPlayLockedLevels()) {
            switch (difficulty) {
                case Easy: 
        ...
        Game.stopMusic();
        Game.anim_init_data.dlearTransforms();

        switch (difficulty) {
            case Easy:
                if (level_number >= 1 && level_number <= 15) {
                    Game.anim_init_data.setFaces(Face_Easy01, Face_Easy04, Face_Menu);
                }

                if (level_number >= 16 && level_number <= 30) {
                    Game.anim_init_data.setFaces(Face_Easy02, Face_Easy01, Face_Empty);
                }

                if (level_number >= 31 && level_number <= 45) {
                    Game.anim_init_data.SetFaces(Face_Easy03, Face_Easy02, Face_Empty);
                }

                if (level_number >= 46 && level_number <= 60) {
                    Game.anim_init_data.SetFaces(Face_Easy04, Face_Easy03, Face_Empty);
                }
                break;

            case Normal:
                if (level_number >= 1 && level_number <= 15) {
                    Game.anim_init_data.setFaces(Face_Normal01, Face_Normal04, Face_Easy01);
                }

                if (level_number >= 16 && level_number <= 30) {
                    Game.anim_init_data.setFaces(Face_Normal02, Face_Normal01, Face_Empty);
                }

                if (level_number >= 31 && level_number <= 45) {
                    Game.anim_init_data.setFaces(Face_Normal03, Face_Normal02, Face_Empty);
                }

                if (level_number >= 46 && level_number <= 60) {
                    Game.anim_init_data.setFaces(Face_Normal04, Face_Normal03, Face_Empty);
                }
                break;

            case Hard:
                if (level_number >= 1 && level_number <= 15) {
                    Game.anim_init_data.setFaces(Face_Hard01, Face_Hard04, Face_Normal01);
                }

                if (level_number >= 16 && level_number <= 30) {
                    Game.anim_init_data.setFaces(Face_Hard02, Face_Hard01, Face_Empty);
                }

                if (level_number >= 31 && level_number <= 45) {
                    Game.anim_init_data.setFaces(Face_Hard03, Face_Hard02, Face_Empty);
                }

                if (level_number >= 46 && level_number <= 60) {
                    Game.anim_init_data.setFaces(Face_Hard04, Face_Hard03, Face_Empty);
                }
                break;
        }
        ...
        Game.level_init_data.init_action = FullInit;

        Game.anim_init_data.type = AnimToLevel;
        ...
        Game.anim_init_data.camera_from = m_camera_current;
        Game.anim_init_data.camera_to = engine.m_level.m_camera_level;

        Game.anim_init_data.pos_light_from = m_pos_light_current;
        Game.anim_init_data.pos_light_to = engine.m_level.m_pos_light;
        ...
        switch (type) {
            ...
            case RenderOnlyMovingCubes: 
                ...
                case RenderOnlyLevelCubes: {
                    ...
                    for (int i = 0 begin(); it != Game.ar_cubefacedata[m_current_cube_face_type].lst_level_cubes.end(); ++it) {
...
//        return RenderForPicking(RenderOnlyLevelCubes);
        ...
        Game.drawFBOTexture(Graphics.texture_id_dirty, color);
...
//    printf("\ncMenu::OnFingerDown");
    ...
    if ( m_navigator.isCurrentNavigation(NoNavigation) && 
        ...
        m_pStoreCubeNoAds.isDone() ) {
            ...
            m_color_down = Graphics.getColorFromScreen(m_pos_down);
    ...
    public void fingerUpOnFaceOptions() {
        ...
        m_color_down = Graphics.getColorFromScreen(m_pos_down);
        m_color_up = Graphics.getColorFromScreen(m_pos_up);
        ...
        if (m_color_down.r == m_color_up.r) {
            ...
            if (!m_showing_help) {
                if (255 == m_color_down.r || 200 == m_color_down.r || 100 == m_color_down.r) {
                    ...
                    MenuFaceBuilder.resetTransforms();
                    MenuFaceBuilder.buildTexts(Face_Menu, Face_Z_Plus, true);
                }
            }
        }
    }
    ...
    public void handleSwipe() {
        ...
        if (menuCube) {
            switch (swipeDir) {
                ...
                case SwipeUp:
                    switch (m_current_cube_face) {
                        case Face_Store:    menuCube.moveOnAxis(Z_Plus); break;
                ...
                case SwipeDown:
                    switch (m_current_cube_face) {
                        case Face_Store:    menuCube.moveOnAxis(Z_Minus); break;
